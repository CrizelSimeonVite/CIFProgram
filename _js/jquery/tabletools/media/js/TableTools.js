 ...
 */
 BPath= $(location)[0].protocol+'//'+$(location)[0].hostname+(($(location)[0].port != '')?':'+$(location)[0].port:'')+'/_public/images/';
TableTools.BUTTONS = {
	"csv": {
		"sAction": "flash_save",
		"sCharSet": "utf8",
	...
	"xls": {
		...
		"sButtonText": "<img src='"+BPath+"excel.png' alt='Download EXCEL File'>",
		"mColumns": "all",
		"bHeader": true,
		"bFooter": true,
		"bSelectedOnly": false,
	...
	"pdf": {
		...
		"sButtonText": "<img src='"+BPath+"pdf.png' alt='Download PDF File'>",
		"mColumns": "all",
		"bHeader": true,
		"bFooter": false,
		"bSelectedOnly": false,
