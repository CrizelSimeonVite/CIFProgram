		...
		return this.each(function() {
			...
			if(fullText.length > options.length + options.minTrail) {
				...
				if(splitLocation != -1) {
					...
					obj.html(str1+ "<span class='truncate_more_link link' title='Click to view full descritpion.'> (<span style='font-size:14px; font-weight:bold;'>+</span>)</span>");
					...
					moreLink.click(function() {
						...
						*/
						...
						var indx = $(this).closest('tr').index();//$(this).parent().parent().index();
						$("#"+tableID+" tbody tr div.item-info-link").eq(indx).trigger("click");
